...
public class Main {
    public static void main(String[] args) {
        ...
        File file = new File("myDB.txt");
        try {
            LoadSaveGroup.saveObject(file, group242);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        Group group500 = null;
        try {
            group500 = (Group) LoadSaveGroup.loadObject(file);
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }
        System.out.println();
        group500.studentAdd(two);
        System.out.println(group500);
    }
}
